...
namespace DOTSHexagons
{
	...
	public static class HexMetrics
	{
		...
		public static void SetNoiseColours()
        {
			...
			HexMetrics.noiseColours = new NativeArray<float4>(noiseColours, Allocator.Persistent);
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static float4 SampleNoiseOld(float3 position, int wrapSize)
		{
		...
		public static Entity HexMeshPrefab;
		public static Material terrianMat;
		public static Material riverMat;
		public static Material roadMat;
		public static Material waterMat;
		public static Material WaterShoreMat;
		public static Material EstuariesMat;
		public static Material WallsMat;

		public static Material GetMaterial(MeshMaterial meshMaterial)
        {
            return meshMaterial switch
            {
                MeshMaterial.Terrian => terrianMat,
                MeshMaterial.River => riverMat,
                MeshMaterial.Water => waterMat,
                MeshMaterial.WaterShore => WaterShoreMat,
                MeshMaterial.Estuaries => EstuariesMat,
                MeshMaterial.Roads => roadMat,
                MeshMaterial.Walls => WallsMat,
                _ => null,
            };
		}
	}
    ...
    public struct HexHash : IBufferElementData
	{
		...
		{
			HexHash hash;
			hash.a = UnityEngine.Random.value * 0.999f;
			hash.b = UnityEngine.Random.value * 0.999f;
			hash.c = UnityEngine.Random.value * 0.999f;
			hash.d = UnityEngine.Random.value * 0.999f;
			hash.e = UnityEngine.Random.value * 0.999f;
			return hash;
		}
