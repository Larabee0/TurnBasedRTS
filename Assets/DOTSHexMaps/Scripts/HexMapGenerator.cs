...
namespace DOTSHexagons
{
    ...
    public class HexMapGeneratorSystem : JobComponentSystem
    {
        ...
        private readonly EntityQueryDesc GenerateMapQueryDesc = new EntityQueryDesc { All = new ComponentType[] { typeof(HexGridComponent), typeof(GenerationSettings),typeof(HexGridCreated),typeof(Generate) } };
        ...
        {
            EntityQuery GenerateMapQuery = GetEntityQuery(GenerateMapQueryDesc);
    ...
    public class HexMapGenerator : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            //GenerateMap(grid.cellCountX, grid.cellCountZ, grid.wrapping);
        }
        ...
        public void GenerateMap(int x, int z, bool wrapping)
        {
            ...
            Entity gridEntity = entityManager.CreateEntity(typeof(Translation), typeof(LocalToWorld), typeof(HexGridComponent), typeof(Child), typeof(HexCell), typeof(HexGridChunkBuffer), typeof(Generate), typeof(HexGridUnInitialised), typeof(HexHash));
            HexMetrics.ActiveGridEntity = gridEntity;
