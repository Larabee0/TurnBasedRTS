...
//     {
//         public enum MeshCookingOptions
//         {
//             None = 0,
//             EnableMeshCleaning = 1,
//             WeldColocatedVertices = 2,
//         }
// 
...
//         public static BlobAssetReference<Collider> Create(NativeArray<float3> vertices, NativeArray<int> indices, MeshCookingOptions cookingOptions = MeshCookingOptions.EnableMeshCleaning | MeshCookingOptions.WeldColocatedVertices) =>
//             Create(vertices, indices, CollisionFilter.Default, Material.Default, cookingOptions);
// 
//         public static BlobAssetReference<Collider> Create(NativeArray<float3> vertices, NativeArray<int> indices, CollisionFilter filter, MeshCookingOptions cookingOptions = MeshCookingOptions.EnableMeshCleaning | MeshCookingOptions.WeldColocatedVertices) =>
//             Create(vertices, indices, filter, Material.Default, cookingOptions);
// 
//         public static unsafe BlobAssetReference<Collider> Create(NativeArray<float3> vertices, NativeArray<int> indices, CollisionFilter filter, Material material, MeshCookingOptions cookingOptions = MeshCookingOptions.EnableMeshCleaning | MeshCookingOptions.WeldColocatedVertices)
//         {
...
// 
//             // Copy indices
//             NativeArray<int> tempIndices;
// 
//             if ((cookingOptions & MeshCookingOptions.EnableMeshCleaning) == MeshCookingOptions.EnableMeshCleaning)
//             {
//                 tempIndices = new NativeArray<int>(numIndices, Allocator.Temp);
// 
...
//             else
//             {
//                 tempIndices = new NativeArray<int>(indices, Allocator.Temp);
//             }
// 
//             // Build connectivity and primitives
// 
//             NativeList<float3> uniqueVertices;
// 
//             if ((cookingOptions & MeshCookingOptions.WeldColocatedVertices) == MeshCookingOptions.WeldColocatedVertices)
//             {
//                 uniqueVertices = MeshConnectivityBuilder.WeldVertices(tempIndices, tempVertices);
//             }
//             else
//             {
//                 uniqueVertices = new NativeList<float3>(tempVertices.Length, Allocator.Temp);
//                 uniqueVertices.AddRange(tempVertices);
//             }
// 
// 
...
// 
//             int primitivesLength = primitives.Length;
// 
//             // Build bounding volume hierarchy
//             int nodeCount = math.max(primitivesLength * 2 + 1, 2); // We need at least two nodes - an "invalid" node and a root node.
//             var nodes = new NativeArray<BoundingVolumeHierarchy.Node>(nodeCount, Allocator.Temp);
//             int numNodes = 0;
// 
//             {
//                 // Prepare data for BVH
//                 var points = new NativeList<BoundingVolumeHierarchy.PointAndIndex>(primitivesLength, Allocator.Temp);
//                 var aabbs = new NativeArray<Aabb>(primitivesLength, Allocator.Temp);
// 
